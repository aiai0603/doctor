...
public class ConsultAskEntity {
    ...
    private String doctorLevelCode; /**医生职称代码*/
    ...
    private Byte consultStatus; /**复诊配药状态，1待接诊，2进行中，3已完成*/
    ...
    @Basic
    @Column(name = "doctor_level_code")
    public String getDoctorLevelCode() {
        return doctorLevelCode;
    }

    public void setDoctorLevelCode(String doctorLevelCode) {
        this.doctorLevelCode = doctorLevelCode;
    }
    ...
    @Basic
    @Column(name = "person_gender_code")
    ...
    public boolean equals(Object o) {
        ...
        return personAge == that.personAge && Objects.equals(consultId, that.consultId) && Objects.equals(orgId, that.orgId) && Objects.equals(orgName, that.orgName) && Objects.equals(deptId, that.deptId) && Objects.equals(deptName, that.deptName) && Objects.equals(doctorId, that.doctorId) && Objects.equals(doctorName, that.doctorName) && Objects.equals(doctorLevelCode, that.doctorLevelCode) && Objects.equals(doctorLevelName, that.doctorLevelName) && Objects.equals(createUserId, that.createUserId) && Objects.equals(personName, that.personName) && Objects.equals(personCardType, that.personCardType) && Objects.equals(personCardId, that.personCardId) && Objects.equals(personGenderCode, that.personGenderCode) && Objects.equals(personGenderName, that.personGenderName) && Objects.equals(personBirthDate, that.personBirthDate) && Objects.equals(personPhoneNo, that.personPhoneNo) && Objects.equals(question, that.question) && Objects.equals(diagnosis, that.diagnosis) && Objects.equals(drugIds, that.drugIds) && Objects.equals(drugNames, that.drugNames) && Objects.equals(photoIds, that.photoIds) && Objects.equals(consultStatus, that.consultStatus) && Objects.equals(createTime, that.createTime) && Objects.equals(acceptTime, that.acceptTime) && Objects.equals(finishTime, that.finishTime);
    }

    @Override
    public int hashCode() {
        return Objects.hash(consultId, orgId, orgName, deptId, deptName, doctorId, doctorName, doctorLevelCode, doctorLevelName, createUserId, personName, personCardType, personCardId, personGenderCode, personGenderName, personBirthDate, personAge, personPhoneNo, question, diagnosis, drugIds, drugNames, photoIds, consultStatus, createTime, acceptTime, finishTime);
    }
}
